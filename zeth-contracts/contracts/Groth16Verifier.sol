...
contract Groth16Verifier {
    ...
    struct VerifyingKey {
        ...
        Pairing.G2Point G2Gen; // Point used to encode elements in G2
    ...
    event LogVerifierUint(uint);

    constructor(
        uint[2] memory Alpha,
        uint[2] memory Beta1,
        uint[2] memory Beta2,
        uint[2] memory G2Gen1,
        uint[2] memory G2Gen2,
        ...
        verifyKey.G2Gen = Pairing.G2Point(G2Gen1, G2Gen2);
    ...
    function verify(uint[] memory input, Proof memory proof) internal returns (uint) {
        ...
        // e(Proof.A, Proof.B) = e(vk.Alpha, vk.Beta) * e(vk_x, vk.G2Gen) * e(Proof.C, vk.Delta)
        // where:
